...
F 3 "" H 900 6950 60  0000 C CNN
	...
	1    0    0    -1  
$EndComp
Text GLabel 8900 7950 2    60   Output ~ 0
AD0
...
U 1 1 5506D3D1
P 7600 8150
F 0 "C105" H 7400 8250 50  0000 L CNN
...
U 1 1 55078E71
P 8550 8850
F 0 "C107" H 8350 8950 50  0000 L CNN
...
Notes on the 1nF-1nF-BAT54 network of all ADC inputs. \nThe high-side C and the dual-diode should be placed \nnear the connector of the signal. \nThe low-side C should be placed near the ADC input pin. \n
Wire Wire Line
...
U 1 1 5514F777
P 12700 2950
F 0 "C1703" V 12550 2900 50  0000 L CNN
F 1 "100n/X7R" V 12850 2750 50  0000 L CNN
F 2 "Capacitors_SMD:C_0603" H 12738 2800 30  0001 C CNN
F 3 "" H 12700 2950 60  0000 C CNN
	1    12700 2950
	0    -1   -1   0   
$EndComp
Wire Wire Line
	12500 2950 11600 2950
Connection ~ 11600 2950
$Comp
L GND #PWR017
U 1 1 55150219
P 12900 2950
F 0 "#PWR017" H 12900 2700 60  0001 C CNN
F 1 "GND" H 12900 2800 60  0000 C CNN
